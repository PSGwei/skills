...
- Annotate with **inline comments explaining _why_**, not just _what_. The `what` is visible in the code; the `why` is what the learner needs.
...
- Follow the format in `GLOSSARY-FORMAT.md`
- Prefer official terminology from developer.android.com and kotlinlang.org
- Cross-reference terms inside definitions (a definition may use a term that is itself in the glossary)
- Flag where Android and Kotlin communities use different words for the same thing

### MISSION.md
- Captures the topic and scope of the multi-lesson series
- What does mastery look like for this topic?
- What is explicitly out of scope?
- Follow the format in `MISSION-FORMAT.md`

### RESOURCES.md
- List every official doc page, article, or video cited across lessons
- Annotate each: what it covers, when to reach for it
- Follow the format in `RESOURCES-FORMAT.md`

### Learning Records
- Write one after each lesson in a series
- Capture: the core concept taught, why it unlocks the next lesson, any pre-empted misconceptions
- Follow the format in `LEARNING-RECORD-FORMAT.md`

### NOTES.md
- User preferences stated during any session (coding style choices, topics to skip, feedback on lesson difficulty)
- Check this file at the start of each new session
